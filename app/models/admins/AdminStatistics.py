...
class AdminStatistics(BaseModel):
    ...
    __table_args__ = (
        CheckConstraint(
            scheduled_requests >= 0, name='check_scheduled_requests_non_negative'
        ),
        CheckConstraint(success_logins >= 0, name='check_success_logins_non_negative'),
        CheckConstraint(failed_logins >= 0, name='check_failed_logins_non_negative'),
        {},
    )
